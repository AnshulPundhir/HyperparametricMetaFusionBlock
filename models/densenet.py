...
class densenet_fusion(nn.Module):
    def __init__(self, im_size, num_classes, init_weights = "kaimingNormal"): 
        super(densenet_fusion, self).__init__()
        ...
        self.adaptive_conv = nn.Conv2d(1024, 1024, kernel_size = int(im_size / 32), padding = 0, bias = True)
     
        self.meta_fusion = meta_fusion(1024, 73)
        ...
        self.classifier = nn.Linear(128, self.num_classes, bias = True)
