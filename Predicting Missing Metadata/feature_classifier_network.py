...
class feature_classifier(nn.Module):
    def __init__(self, num_layers, drop_batchnorm= False):
        ...
        #You can define your own layer_config depending on the number of encoded features you are using to predict another feature, how many classes does the target feature have, and how many layers you want in the network.  
